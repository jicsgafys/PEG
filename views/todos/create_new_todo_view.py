...
class CreateNewTodoView(MDBoxLayout):
    def __init__(self):
        super().__init__()
        ...
        ##############################################
        self.top_nav = MDTopAppBar(title="New Todo", elevation=4, md_bg_color=(0.2, 0.5, 0.9, 1),
        ...
        self.percent_progress = AngelaCombobox("Percentage Progress", [str(i) for i in range(0, 101, 10)])
