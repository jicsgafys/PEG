...
class GeoidModelCalculateView(MDBoxLayout):
    def __init__(self):
        super().__init__()
        ...
        # self.accuracy_combo = AngelaCheckbox("Check Accuracy")
        # self.accuracy_combo.size_hint = (None, None)
        # self.accuracy_combo.size = (250, 70)
        self.model_checks_widget = AngelaCheckbox("Show Model Detail")
        self.model_checks_widget.size_hint = (None, None)
        self.model_checks_widget.size = (250, 70)
        ...
        # self.home_bottom_content.add_widget(self.accuracy_combo)
        self.home_bottom_content.add_widget(self.model_checks_widget)
