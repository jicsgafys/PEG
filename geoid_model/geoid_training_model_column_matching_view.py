...
class GeoidModelTrainingColumnMatchingView(MDBoxLayout):
    def __init__(self, column_header):
        ...
        self.body_title_label = MDLabel(text="Column Matching [Training]", size_hint=(1, 1), font_style="H6")
        ...
        self.home_bottom_content.height = 800
        ...
        self.base_station_combo = AngelaCombobox("Base Station", self.column_header)
        self.base_station_combo.drop_down_button.set_item(self.column_header[0])
        self.base_station_combo.size_hint = (None, None)
        self.base_station_combo.size = (250, 70)
        ...
        self.gps_height_combo = AngelaCombobox("GPS/Ellipsoidal Height", self.column_header)
        self.gps_height_combo.drop_down_button.set_item(self.column_header[0])
        self.gps_height_combo.size_hint = (None, None)
        self.gps_height_combo.size = (250, 70)
        self.orthometric_height_combo = AngelaCombobox("Orthometric Height", self.column_header)
        self.orthometric_height_combo.drop_down_button.set_item(self.column_header[0])
        self.orthometric_height_combo.size_hint = (None, None)
        self.orthometric_height_combo.size = (250, 70)

        self.home_bottom_content.add_widget(self.station_combo)
        self.home_bottom_content.add_widget(self.base_station_combo)
        ...
        self.home_bottom_content.add_widget(self.orthometric_height_combo)
    ...
    def reset_combo_drop_down_items(self):
        combos = (self.station_combo, self.gps_easting_combo,
                  self.gps_height_combo,
                  self.gps_northing_combo,
                  self.orthometric_height_combo, self.base_station_combo)
        for combo in combos:
            menu_items = []
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = GeoidModelTrainingColumnMatchingView(["Column " + str(x) for x in range(10)])
