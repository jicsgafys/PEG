...
class GeoidModelPredictionFileUploadView(MDBoxLayout):
    def __init__(self):
        super().__init__()
        ...
        ##################################################
        self.body_content = MDBoxLayout(orientation='vertical', size_hint=(1, 0.9),
                                        padding=[50, 0, 50, 0])
        self.body.add_widget(self.body_content)
        # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

        self.body_title_label = MDLabel(text="File Upload [Prediction]",
                                        size_hint=(1, None), font_style="H6")
        self.body_title_label.height = 10
        self.body_content.add_widget(self.body_title_label)

        self.file_upload = AngelaFileUpload()
        self.file_upload.size_hint = (1, 0.2)
        self.file_upload.padding = [0, 0, 0, 20]
        ...
        self.header_checkbutton.padding = [0, 20, 50, 25]
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = GeoidModelPredictionFileUploadView()
