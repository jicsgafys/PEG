...
from views.traversing.traversing_file_upload_view import TraversingFileUploadView


class TraversingFileUploadController(MDBoxLayout):
    def __init__(self):
        super().__init__()

        self.ui = TraversingFileUploadView()
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = TraversingFileUploadController()
