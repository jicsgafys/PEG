...
from views.geoid_model.geoid_model_training_file_upload_view import GeoidModelTrainingFileUploadView


class GeoidModelTrainingFileUploadController(MDBoxLayout):
    def __init__(self):
        super().__init__()
        self.ui = GeoidModelTrainingFileUploadView()
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = GeoidModelTrainingFileUploadController()
