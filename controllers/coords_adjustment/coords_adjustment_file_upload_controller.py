...
from views.coords_adjustment.coords_adjustment_file_upload_view import CoordsAdjustmentFileUploadView


class CoordsAdjustmentFileUploadController(MDBoxLayout):
    def __init__(self):
        super().__init__()

        self.ui = CoordsAdjustmentFileUploadView()
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = CoordsAdjustmentFileUploadController()
