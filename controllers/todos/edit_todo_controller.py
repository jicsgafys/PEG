...
from models.todos.todos import RetrieveOneTodo, ModifyTodo
from views.todos.edit_todo_view import EditTodoView


class EditTodoController(MDBoxLayout):
    def __init__(self, main_container_widget, previous_widget, todo_id):
        ...
        self.ui.action_buttons.next_button.on_release = lambda: self.modify_todo()
    ...
    def retrieve_todo(self):
        ...
        #
        self.ui.todo_task_start_date.date_input_entry.disabled = True
        self.ui.todo_task_expected_end_date.date_input_entry.disabled = True
        self.ui.todo_task_expected_end_date.date_input_entry.disabled = True
    ...
    def modify_todo(self):
        ...
        def continue_modify():
            ...
            todo.modify(self.todo_id, title, description, assignees, start_date, expected_end_date,
