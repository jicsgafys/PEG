...
from views.levels_adjustment.adjustment_calculate_view import AdjustmentCalculateView

from models.levels_adjustment.levels_adjustment_model import LevelsAdjustment, \
    save_csv_data


class AdjustmentCalculateController(MDBoxLayout):
    def __init__(self, main_container_widget, previous_widget, data):
        ...
        self.ui = AdjustmentCalculateView()
    ...
    def perform_computations(self):
        ...
        def continue_computations():
            ...
            model = LevelsAdjustment(self.data['filepath'], self.data['first_row_as_header'],
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = AdjustmentCalculateController(None, None, None)
