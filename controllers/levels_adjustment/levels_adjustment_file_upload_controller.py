...
from views.levels_adjustment.adjustment_file_upload_view import AdjustmentFileUploadView


class AdjustmentFileUploadController(MDBoxLayout):
    def __init__(self):
        super().__init__()

        self.ui = AdjustmentFileUploadView()
...
if __name__ == "__main__":
    ...
    class MainApp(MDApp):
        ...
        def build(self):
            app = AdjustmentFileUploadController()
